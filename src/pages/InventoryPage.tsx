  ...
  return (
    <div className="flex flex-col gap-8 pb-12">
      ...
      >
        ...
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight text-white light:text-slate-900 truncate">Inventory</h1>
            <span className="rounded-full border border-amber-500/30 bg-amber-500/10 px-2.5 py-0.5 sm:px-3 sm:py-1 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-amber-400 light:text-amber-700">
              Coming Soon
            </span>
          </div>
      ...
      >
        ...
        <div className="grid grid-cols-4 gap-2.5 opacity-30 blur-[2px] sm:grid-cols-6 md:grid-cols-8">
          {slots.map((_, i) => (
